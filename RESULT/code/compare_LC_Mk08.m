...
axis( [0,110,525,610])  %确定x轴与y轴框图大小
set(gca,'XTick',[0:10:110]) %x轴范围
set(gca,'YTick',[525:5:610]) %y轴范围
legend('无局部搜索算子的模因算法','带局部搜索算子的改进模因算法','Location','NorthEast', 'FontSize',10,'FontWeight','normal');   %右下角标注
...
imwrite(img,'../结果图/LC_Mk08.png'); % 保存到工作目录下，名字为"a.png"