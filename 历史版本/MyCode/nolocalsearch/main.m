...
for iter = 1:numOfIterate-1
    ...
    %%%种群选择
    %序列合并
    PopulationTs_merge1 = [PopulationTs_merge0;PopulationTs_elite_new3;PopulationTs_ordinary_new3;PopulationTs_hybrid_new1];
    PopulationFs_merge1 = [PopulationFs_merge0;PopulationFs_elite_new3;PopulationFs_ordinary_new3;PopulationFs_hybrid_new1];
    PopulationMs_merge1 = [PopulationMs_merge0;PopulationMs_elite_new3;PopulationMs_ordinary_new3;PopulationMs_hybrid_new1];
    %适应度值合并
    makespan = makespan_population_T_iter(iter,:).';
    makespan_population_new1 = [makespan;makespan_population_elite2;makespan_population_ordinary2;makespan_population_hybrid];
    ...
    makespan_population_T_iter(iter+1,:) = makespan_population_merge;
