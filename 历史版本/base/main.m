...
%解码与适应度评价
[F_S,F_T,M_S,M_T,start_Time_pop0,end_Time_pop0,start_Time_trans1,end_Time_trans1] = decode(numOfTasks,numOfSubTasks,vectormcellPerFactory,numOfTotalMcell,vectorNumSubTasks,vectorSumOfSubTasks,numOfPopulation,PopulationTs,PopulationFs,PopulationMs,tableOfTransTime,tableOfManuTime);
[makespan_population0,makespan_best0,index0,index_Population0] = fitness(end_Time_trans1,numOfPopulation);
...
for iter = 1:numOfIterate-1
    ...
    [PopulationTs_new1,PopulationFs_new1,PopulationMs_new1] = mutation1(PopulationTs_new,PopulationFs_new,PopulationMs_new,P_m,numOfTasks,numOfPopulation,mcellPerFactory,numOfSubTasks,vectorNumSubTasks,vectorSumOfSubTasks,vectormcellPerFactory,tableOfMcellOptional,tableOfTransTime,tableOfManuTime);
    ...
    makespan_best_iter(iter+1,1) = makespan_best_merge_update;
    ...
    index_best_iter(iter+1,1) = index_best_T_update;
    index_Population_iter(:,:,iter+1) = index_Population_T_update;
end
