...
%参数设置
source = '../DataSet/mk/Mk09_DFJSP.mat';
% source = '../DataSet/mt20_DFJSP.mat';
...
%     P_c = P_c0 * ((numOfIterate-iter)/numOfIterate);
    ...
    %%%种群分级
    [PopulationTs_elite,PopulationFs_elite,PopulationMs_elite,makespan_population_elite0,PopulationTs_ordinary,PopulationFs_ordinary,PopulationMs_ordinary,makespan_population_ordinary0] = classifyPopulation(numOfPopulation,PopulationTs_merge,PopulationFs_merge,PopulationMs_merge,makespan_population_merge,K);
    ...
    %%%序列合并
    PopulationTs_merge0 = [PopulationTs_elite_new2;PopulationTs_ordinary_new2;PopulationTs_hybrid_new1];
    PopulationFs_merge0 = [PopulationFs_elite_new2;PopulationFs_ordinary_new2;PopulationFs_hybrid_new1];
    PopulationMs_merge0 = [PopulationMs_elite_new2;PopulationMs_ordinary_new2;PopulationMs_hybrid_new1];
    %解码
    [start_Time_pop_merge0,end_Time_pop_merge0] = decode(numOfTasks,numOfSubTasks,vectormcellPerFactory,numOfTotalMcell,vectorNumSubTasks,vectorSumOfSubTasks,numOfPopulation,PopulationTs_merge0,PopulationFs_merge0,PopulationMs_merge0,tableOfManuTime);
