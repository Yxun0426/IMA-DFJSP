...
%绘制甘特图
axis([-20,makespan_best+20,0,numOfTotalMcell+1]);%x轴 y轴的范围
set(gca,'xtick',0:10:makespan_best);%x轴的增长幅度
set(gca,'ytick',[],'yticklabel',[]);%y轴
ax=gca;
...
for f = 1:numOfFactory
    ...
    text(-18,start + 0.5 + num/2,txt_fac,'FontSize',10,'FontWeight','Bold','FontName','Times New Roman');
end
...
for p = 1:numOfFactory
    ...
    for m = 1:num_mcell
        ...
        text(-8,count,txt_mcell,'FontSize',10,'FontWeight','Bold','FontName','Times New Roman');
    end
end
%%%颜色图设计
