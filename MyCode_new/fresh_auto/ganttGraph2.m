function ganttGraph2(numOfFactory,mcellPerFactory,vectormcellPerFactory,numOfTasks,numOfSubTasks,numOfTotalMcell,makespan_best,start_Time_best,end_Time_best,PopulationTs_best,vectorSumOfSubTasks)
%绘制甘特图
