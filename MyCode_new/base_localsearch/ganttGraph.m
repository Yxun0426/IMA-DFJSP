...
for f = 1:numOfFactory
    ...
    text(-17.5,start + 0.5 + num/2,txt_fac,'FontSize',10,'FontWeight','Bold','FontName','Times New Roman');
end
...
for p = 1:numOfFactory
    ...
    for m = 1:num_mcell
        ...
        text(-7.5,count,txt_mcell,'FontSize',10,'FontWeight','Bold','FontName','Times New Roman');
    end
end
