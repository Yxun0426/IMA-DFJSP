...
start = cputime;
%参数设置
source = './mydata/BR/Mk09_DFJSP.mat';
...
for iter = 1:numOfIterate
    ...
    %解码
%     [start_Time_pop,end_Time_pop] = decode(numOfTasks,numOfSubTasks,vectormcellPerFactory,numOfTotalMcell,vectorNumSubTasks,vectorSumOfSubTasks,numOfPopulation,PopulationTs_new1,PopulationFs_new1,PopulationMs_new1,tableOfManuTime);
    [start_Time_pop,end_Time_pop,start_Time_trans0,end_Time_trans0] = decode_trans(numOfTasks,numOfSubTasks,vectormcellPerFactory,numOfTotalMcell,vectorNumSubTasks,vectorSumOfSubTasks,numOfPopulation,PopulationTs_new1,PopulationFs_new1,PopulationMs_new1,tableOfManuTime,tableOfTransTime);
    %适应度评价
