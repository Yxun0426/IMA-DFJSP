...
%参数设置
source = '../DataSet/mk/Mk08_DFJSP.mat';
...
for iter = 1:numOfIterate-1
    ...
    %解码与评价
    [start_Time_pop_elite,end_Time_pop_elite] = decode(numOfTasks,numOfSubTasks,vectormcellPerFactory,numOfTotalMcell,vectorNumSubTasks,vectorSumOfSubTasks,K,PopulationTs_elite_new2,PopulationFs_elite_new2,PopulationMs_elite_new2,tableOfManuTime);
    ...
    %解码与评价
    [start_Time_pop_ordinary,end_Time_pop_ordinary] = decode(numOfTasks,numOfSubTasks,vectormcellPerFactory,numOfTotalMcell,vectorNumSubTasks,vectorSumOfSubTasks,K,PopulationTs_ordinary_new2,PopulationFs_ordinary_new2,PopulationMs_ordinary_new2,tableOfManuTime);
    ...
    %解码与评价
    [start_Time_pop_hybrid,end_Time_pop_hybrid] = decode(numOfTasks,numOfSubTasks,vectormcellPerFactory,numOfTotalMcell,vectorNumSubTasks,vectorSumOfSubTasks,numOfPopulation-K,PopulationTs_hybrid_new1,PopulationFs_hybrid_new1,PopulationMs_hybrid_new1,tableOfManuTime);
    ...
    %%%解码
    [start_Time_pop_merge,end_Time_pop_merge] = decode(numOfTasks,numOfSubTasks,vectormcellPerFactory,numOfTotalMcell,vectorNumSubTasks,vectorSumOfSubTasks,numOfPopulation,PopulationTs_merge1,PopulationFs_merge1,PopulationMs_merge1,tableOfManuTime);
